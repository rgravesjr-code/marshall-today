...
import { Search, X, Eye, EyeOff, ExternalLink, Pencil, Trash2, Plus } from 'lucide-react';
...
export default function AdminBusinessesPage() {
  ...
  return (
    <div>
            ...
            {filtered.map((biz) => (
              <div key={biz.id} className="flex items-center gap-4 px-5 py-3 hover:bg-cream-50 transition-colors">
                ...
                <button
                  ...
                  title={biz.is_published ? 'Click to hide' : 'Click to publish'}
      ...
      <p className="text-center text-marshall-300 text-xs font-sans mt-4">
